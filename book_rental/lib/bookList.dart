  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          if (isAvailable) {
            ...
            // Book is rented, so don't show it in the list
            return SizedBox();
          }
        },
      ),
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          final returnedBookId = await Navigator.pushNamed(context, '/Rents');
          if (returnedBookId != null) {
            _getBooks(); // Refresh the book list after returning a book
          }
        },
